...
1. create table store (id bigint generated by default as identity, address varchar(255), description varchar(255), holidays binary(255), level bigint not null, name varchar(255), owner varchar(255), phone varchar(255), primary key (id))
1. create table store_business_times (store_id bigint not null, business_times_id bigint not null)
